...
public class ListUtility {
	public Node readFile(Node head) throws IOException {
		BufferedReader br = new BufferedReader(new FileReader("/home/admin237/Desktop/MY_WS/DataStructure Programs/src/DemoFile.txt"));
		String words = "";
		String word;
	...
	public void writeToFile(String word1) throws IOException {
		FileWriter fw = new FileWriter("/home/admin237/Desktop/MY_WS/DataStructure Programs/src/DemoFile1.txt");
		fw.write(word1);
		fw.close();
	}
}
